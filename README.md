...
![image-20230402233336305](http://tuchuang.taurushu.top/i/2023/04/03/iak8pp.png)
...
![job提交抽象流程](http://tuchuang.taurushu.top/i/2023/04/03/tzicng-1.png)

### 作业提交流程

#### job提交抽象流程

![job提交抽象流程](http://tuchuang.taurushu.top/i/2023/04/03/tuqhe3-1.png)

#### Standalone提交流程

<img src="http://tuchuang.taurushu.top/i/2023/04/03/tzp5qu-1.png" alt="Standalone提交流程" style="zoom: 33%;" />

#### Yarn-session提交流程

<img src="http://tuchuang.taurushu.top/i/2023/04/03/txns4p-1.png" alt="Yarn-session提交流程" style="zoom: 50%;" />

#### Yarn-Per-Job提交流程

<img src="http://tuchuang.taurushu.top/i/2023/04/03/txxfe0-1.png" alt="Yarn-Per-Job提交流程" style="zoom:50%;" />
...
![ExecutionGraph执行图](http://tuchuang.taurushu.top/i/2023/04/03/xivi8g-1.png)
...
![image-20230403213813630](http://tuchuang.taurushu.top/i/2023/04/03/zczntl-1.png)
...
1. shuffle：以`随机策略`将若干数据，发送到所有的分区中去
   ...
   <img src="http://tuchuang.taurushu.top/i/2023/04/05/tw1zut-1.png" alt="Flink分区Shuffle策略" style="zoom:150%;" />

2. rebalance：以`轮询策略`将若干数据，发送到所有的分区中去

   <img src="http://tuchuang.taurushu.top/i/2023/04/05/tw0b7q-1.png" alt="Flink分区Balance策略" style="zoom:150%;" />

3. rescale：以`TaskManager内轮询策略`将若干数据，发送到当前的TaskManager的分区中去

   <img src="http://tuchuang.taurushu.top/i/2023/04/05/twsj8d-1.png" alt="Flink分区Scale策略" style="zoom:150%;" />

特殊分区：

1. broadcast：以`广播策略`将若干数据，发送到所有的分区中去

   <img src="http://tuchuang.taurushu.top/i/2023/04/05/u2f90r-1.png" alt="Flink分区Broadcast策略" style="zoom:150%;" />

2. global：以`全局策略`将若干数据，发送到一个分区中去

   <img src="http://tuchuang.taurushu.top/i/2023/04/05/u2hswc-1.png" alt="Flink分区Global策略" style="zoom:150%;" />
